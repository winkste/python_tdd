...
def test_calling_withdraw_without_balance_returns_zero():
...
def test_withdraw_with_balance_will_return_withdraw():
...
def test_withdraw_with_balance_will_reduce_balance(capsys):
